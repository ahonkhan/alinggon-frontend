        ...
        <div className="space-y-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Manage your inquiries and help requests</p>
                </div>
                <button 
            ...
            {tickets.length === 0 ? (
                <div className="text-center py-4 bg-white rounded-[2rem] border-2 border-dashed border-gray-100">
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-2 max-w-xs mx-auto px-4">You haven't opened any support tickets. If you need help, feel free to open one!</p>
                </div>
            ) : (
                            ...
                            <div className="flex items-center gap-5 relative z-10">
                                ...
                                <div className='ml-2'>
                                    ...
                                    <div className="flex flex-wrap items-center gap-3 mt-2 text-[10px] font-black uppercase tracking-widest">
                                        ...
                                        <span className="text-gray-400 bg-gray-50 px-3 py-1 rounded-lg border border-gray-100">
