                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {cart.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {cart.map((item) => (
                                <div key={item.id} className="flex gap-4 group bg-white p-3 rounded-2xl border border-gray-100 hover:border-red-100 hover:shadow-xl hover:shadow-slate-100/50 transition-all">
