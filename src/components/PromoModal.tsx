            ...
            <div className="relative w-full max-w-2xl bg-white rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-500">
                ...
                <div className="relative aspect-[4/5] md:aspect-video w-full">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent flex flex-col justify-end p-12">
                        <span className="text-red-400 text-xs font-black uppercase tracking-[0.4em] mb-2">Flash Offer</span>
                        <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter uppercase leading-none mb-4">
                            Premium Savings<br />Up to <span className="text-red-400">50% Off</span>
                        </h2>
                        <button
                            onClick={() => setIsOpen(false)}
                            className="w-fit bg-red-400 hover:bg-white hover:text-slate-900 text-white px-8 py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all shadow-xl active:scale-95"
                        >
                            Claim Discount
                        </button>
                    </div>
