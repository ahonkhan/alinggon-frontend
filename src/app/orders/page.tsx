                                    ...
                                    >
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                            <div className="flex items-center gap-6">
                                                <div className="w-16 h-16 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-800 group-hover:bg-red-50 group-hover:text-red-500 transition-colors">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-4 text-[13px] font-black text-slate-800 uppercase tracking-widest">
                                            ...
                                            <div className="flex items-center justify-between md:justify-end gap-10 border-t md:border-t-0 pt-4 md:pt-0">
                                                <div className="text-right">
                                                    <p className="text-[13px] font-black text-slate-800 uppercase tracking-widest mb-1">Total Amount</p>
                                                    <p className="text-xl font-black text-slate-900 tracking-tighter">৳ {order.total_amount}</p>
                                                </div>
                                                <div className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-800 group-hover:bg-slate-900 group-hover:text-white transition-all">
