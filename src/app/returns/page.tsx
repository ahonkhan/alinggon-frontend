    ...
    return (
        <div className="flex gap-8 group">
            ...
            <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-gray-800 uppercase tracking-tight leading-relaxed">{desc}</p>
            </div>
        </div>
    );
}
...
function TrustIcon({ icon: Icon, label }: any) {
    return (
        <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 text-center space-y-3">
            ...
            <p className="text-[13px] font-black text-slate-800 uppercase tracking-[0.2em]">{label}</p>
        </div>
    );
}
